=== Simplified MCE Table Buttons ===
Contributors: mattheu, jakemgold, 10up, thinkoomph
Tags: tables, table, editor, WYSIWYG, buttons, tinymce
Requires at least: 3.4
Tested up to: 4.0
Stable tag: 0.1

A siimplified version of the  MCE Table Buttons plugin by Jake Goldman and 10up. Adds table editing controls to the visual content editor (TinyMCE).
